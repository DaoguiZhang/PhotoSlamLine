...
../bin/tum_mono \
    ...
    /workspace/ZDG/CPlusPlusProjects/Photo-SLAM/datasets/TUM/rgbd_dataset_freiburg1_desk \
...
../bin/tum_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/TUM/tum_mono.yaml \
    /workspace/ZDG/CPlusPlusProjects/Photo-SLAM/datasets/TUM/rgbd_dataset_freiburg2_xyz \
...
../bin/tum_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/TUM/tum_mono.yaml \
    /workspace/ZDG/CPlusPlusProjects/Photo-SLAM/datasets/TUM/rgbd_dataset_freiburg3_long_office_household \
