...
#include "CommonTypeORB.h"  //added for LineExtractor
#include "levmar.h"

/*
 * This file is part of PointLine SLAM Project Written by yanyan Li
 * Copyright (c) 2024 yanyan Li, Hong Kong University of Science and Technology.
    * PointLine SLAM is free software: you can redistribute it and/or modify it under the terms of the GNU General Public
    * License as published by the Free Software Foundation, either version 3 of the License, or
    * (at your option) any later version.

    * This file Contains the implementation of line feature extraction using LSD and LBD descriptor.
    * Contains functions to extract line features from images. 
*/
...
namespace ORB_SLAM3
{
    ...
    typedef struct FrameLine   //like keypoint structure(important)
    ...
    // function declarations for line extraction and 3D line fitting
    ...
    std::vector<int> computeRelativeMotion_Ransac (std::vector<RandomLine3d> a, std::vector<RandomLine3d> b, cv::Mat& R, cv::Mat& t);
