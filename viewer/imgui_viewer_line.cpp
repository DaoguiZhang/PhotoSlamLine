...
ImGuiViewerLine::ImGuiViewerLine(
...
void ImGuiViewerLine::readConfigFromFile(std::filesystem::path cfg_path)
{
...
void ImGuiViewerLine::run()
{
    ...
    while(!isStopped() && !glfwWindowShouldClose(window))
    {
        ...
        VariableParametersLine params_in = pGausMapper_->getVaribleParameters();
        ...
        VariableParametersLine params_out;
...
bool ImGuiViewerLine::isStopped()
{
    std::unique_lock<std::mutex> lock_status(this->mutex_status_);
    return this->stopped_;
}

void ImGuiViewerLine::signalStop(const bool going_to_stop)
{
    std::unique_lock<std::mutex> lock_status(this->mutex_status_);
 ...
 */
void ImGuiViewerLine::handleUserInput()
{
    if (tracking_vision_)
    {
...
void ImGuiViewerLine::mouseWheel()
{
...
void ImGuiViewerLine::mouseDrag()
{
...
void ImGuiViewerLine::keyboardEvent()
{
