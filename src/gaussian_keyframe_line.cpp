...
#include "include/gaussian_keyframe_line.h"

void GaussianKeyframeLine::setPose(
    const double qw,
    const double qx,
    const double qy,
    const double qz,
...
Sophus::SE3d GaussianKeyframeLine::getPose()
{
    return this->Tcw_;
}

Sophus::SE3f GaussianKeyframeLine::getPosef()
{
    return this->Tcw_.cast<float>();
}

void GaussianKeyframeLine::setCameraParams(const Camera& camera)
{
...
void GaussianKeyframeLine::setPoints2D(const std::vector<Eigen::Vector2d>& points2D)
{
...
void GaussianKeyframeLine::setPoint3DIdxForPoint2D(
...
void GaussianKeyframeLine::computeTransformTensors()
{
...
Eigen::Matrix4f
GaussianKeyframeLine::getWorld2View2(
...
torch::Tensor
GaussianKeyframeLine::getProjectionMatrix(
    float znear,
    float zfar,
    float fovX,
    float fovY,
...
int GaussianKeyframeLine::getCurrentGausPyramidLevel()
{
