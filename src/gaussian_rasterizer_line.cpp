 ...
 * created by ZDG and modified from Longwei Li, Huajian Huang, Hui Cheng and Sai-Kit Yeung in 2023,
 * as part of Photo-SLAM.
 */

#include "include/gaussian_rasterizer_line.h"

torch::Tensor
GaussianRasterizerWithLine::markVisibleGaussians(
...
GaussianRasterizerFunctionLine::forward(
...
torch::autograd::tensor_list
GaussianRasterizerFunctionLine::backward(
    torch::autograd::AutogradContext *ctx,
...
GaussianRasterizerWithLine::forward(
    torch::Tensor means3D,
    torch::Tensor means2D,
    torch::Tensor opacities,
    bool has_shs,
...

{
    ...
    //modified by ZDG
    auto result = RasterizeGaussiansWithLine(
        means3D,
        means2D,
        shs,
        colors_precomp,
