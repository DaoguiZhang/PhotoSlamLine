...
#include "include/gaussian_parameters_line.h"

GaussianModelParamsLine::GaussianModelParamsLine(
...
GaussianPipelineParamsLine::GaussianPipelineParamsLine(bool convert_SHs, bool compute_cov3D)
    : convert_SHs_(convert_SHs), compute_cov3D_(compute_cov3D)
{}

GaussianOptimizationParamsLine::GaussianOptimizationParamsLine(
    int iterations,
