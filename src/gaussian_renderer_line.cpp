...
#include "include/gaussian_renderer_line.h"
...
GaussianRendererWithLine::renderWithLine(
    std::shared_ptr<GaussianKeyframeLine> viewpoint_camera,
    int image_height,
    int image_width,
    std::shared_ptr<GaussianModelLine> pc,
    ...
    bool use_override_color)
{
    ...
    GaussianRasterizerWithLine rasterizer(raster_settings);
